...
var Zepto = (function () {
  ...
  function N(a, b, d) {
    ...
    e
      ? e.insertBefore(
          d,
          a ? (a == 1 ? e.firstChild : a == 2 ? b : null) : b.nextSibling
        )
      : c(d).remove();
  }
  function O(a, b) {
  ...
  return (
    ...
    (c.extend = function (c) {
      return (
        f.call(arguments, 1).forEach(function (d) {
    ...
    (c.fn = {
      ...
      show: function () {
        return this.each(function () {
          this.style.display == "none" && (this.style.display = null),
            j(this, "").getPropertyValue("display") == "none" &&
      ...
      toggle: function (b) {
        return (b === a ? this.css("display") == "none" : b)
          ? this.show()
          : this.hide();
      },
      prev: function () {
      ...
      css: function (c, d) {
        if (d === a && typeof c == "string")
          return this.length == 0
            ? a
            : this[0].style[x(c)] || j(this[0], "").getPropertyValue(c);
        var e = "";
        for (b in c)
          typeof c[b] == "string" && c[b] == ""
            ? this.each(function () {
    ...
    n.forEach(function (a, b) {
      (c.fn[a] = function () {
        ...
        (c.fn[b % 2 ? a + "To" : "insert" + (b ? "Before" : "After")] =
          function (b) {
...
(window.Zepto = Zepto),
  ...
  (function (a) {
    ...
    (a.fn.delegate = function (b, c, d) {
      ...
      if (c == "blur" || c == "focus")
        a.iswebkit
          ? (c = c == "blur" ? "focusout" : c == "focus" ? "focusin" : c)
          : (e = !0);
        ...
        k(
          ...
          function (c) {
            return function (d) {
              ...
              if (f)
                return (
                  (e = a.extend(p(d), { currentTarget: f, liveFired: g })),
      ...
      (a.fn.on = function (b, c, d) {
        return c == undefined || a.isFunction(c)
          ? this.bind(b, c)
          : this.delegate(c, b, d);
      }),
      ...
      "focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout change select keydown keypress keyup error"
        .split(" ")
        .forEach(function (b) {
          a.fn[b] = function (a) {
  ...
  (function (a, b) {
    ...
    a.each(g, function (a, e) {
      ...
      (k[c + "transition-property"] =
        k[c + "transition-duration"] =
        k[c + "transition-timing-function"] =
        k[c + "animation-name"] =
        k[c + "animation-duration"] =
          ""),
      (a.fx = {
      ...
      (a.fn.anim = function (d, e, f, g) {
        ...
        if (typeof d == "string")
          ...
          h && (i[c + "transform"] = h.join(" ")),
            !a.fx.off &&
              typeof d == "object" &&
              ((i[c + "transition-property"] = Object.keys(d).join(", ")),
  ...
  (function ($) {
    ...
    function serialize(a, b, c, d) {
      ...
      $.each(b, function (b, f) {
        d && (b = c ? d : d + "[" + (e ? "" : b) + "]"),
          !d && e
            ? a.add(f.name, f.value)
            : (c ? $.isArray(f) : isObject(f))
            ? serialize(a, f, c, b)
            : a.add(b, f);
      });
    }
    ...
    ($.active = 0),
      ...
      ($.post = function (a, b, c, d) {
        return (
          $.isFunction(b) && ((d = d || c), (c = b), (b = null)),
          $.ajax({ type: "POST", url: a, data: b, success: c, dataType: d })
        );
      }),
        ...
        .bind("touchend", function (a) {
          i(),
            b.isDoubleTap
              ...
              : (b.x2 && Math.abs(b.x1 - b.x2) > 30) ||
                (b.y2 && Math.abs(b.y1 - b.y2) > 30)
              ? (b.el.trigger("swipe") &&
                  b.el.trigger("swipe" + e(b.x1, b.x2, b.y1, b.y2)),
                (b = {}))
              : "last" in b &&
                (b.el.trigger("tap"),
